# Dante's Inferno — Canto I Reader
...
- **English translation & word mapping** — Generated with Claude (Anthropic) to follow Italian word order for parallel reading.
- **Audio** — ElevenLabs text-to-speech (multilingual v2) with word-level timing alignment.
